...
// [POS]: launcher for the skill layer's scripted stations (naming/plan/simulate/decide/
//   rollout-validate/report/learn); mirrors bin/growth-machine's "locate project root, run via
//   local tsx, no global install" pattern, just in Node instead of bash — plain `node` cannot
//   resolve this repo's internal .js-import-pointing-at-.ts-source specifiers, tsx can
